...
import type { Kelurahan } from "@/services/kelurahanService";
...
interface ShowDataProps {
  ...
  totalCount: number;
  pageSize: number;
  onEdit: (item: Kelurahan) => void;
  onDelete: (item: Kelurahan) => void;
        ...
        <table className="table table-zebra w-full">
          <thead>
            <tr className="bg-base-200">
              ...
              <th className="text-xs">Nama Kelurahan</th>
              {data[0]?.kecamatan_nama && (
                <th className="text-xs">Kecamatan</th>
              )}
