...
import type { TypeKendaraan } from "@/services/typeKendaraanService";
...
interface ShowDataProps {
  ...
  totalCount: number;
  pageSize: number;
  onEdit: (item: TypeKendaraan) => void;
  onDelete: (item: TypeKendaraan) => void;
        ...
        <table className="table table-zebra w-full">
          <thead>
            <tr className="bg-base-200">
              ...
              <th className="text-xs">Nama Type</th>
              {data[0]?.merek_nama && (
                <th className="text-xs">Merek</th>
              )}
